return {
  ...
  -- I removed tags = "0.1.4" here (fyi just in case that causes problems)
  config = function(_, opts)
    ...
    opts.defaults.mappings.n = vim.tbl_deep_extend("force",
      opts.defaults.mappings.n or {},
      {
        ["<esc>"] = actions.close,
        ["<CR>"] = actions.select_default,
        ["<C-x>"] = actions.select_horizontal,
        ...
        ["<Tab>"] = actions.toggle_selection + actions.move_selection_worse,
        ["<S-Tab>"] = actions.toggle_selection + actions.move_selection_better,
        -- ["<C-q>"] = actions.send_to_qflist + actions.open_qflist, -- Ctrl-q is dangerous in zellij
